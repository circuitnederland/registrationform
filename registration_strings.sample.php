...
function lang($phrase){
	static $lang = array(
			...
			'confirmation.explain'	=> "<p>Gefeliciteerd, je account is geactiveerd.</p><p>Je kunt nu inloggen in je <a href=\"%s\" target=\"_blank\">Circuit Nederland account</a>.</p><p>Om in te loggen gebruik je jouw gebruikersnaam (%s) of e-mailadres (%s) en het door jou gekozen wachtwoord.</p>",
