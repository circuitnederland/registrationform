...
function lang($phrase){
	static $lang = array(
			...
			'error.noUser'			=> "Geen gebruiker bekend. Er is iets misgegaan met de link van uw mail. Neem a.u.b. contact op met de administratie.", 
			...
			'error.missingLoginInfo'=> "Uw inschrijving is verwerkt maar er is een probleem met het weergeven van uw inlog gegevens.",
			'field.address'			=> "Adres",
			...
			'confirmation.explain'	=> "<p>Gefeliciteerd, uw account is geactiveerd.</p><p>U kunt nu inloggen in uw <a href=\"%s\">Circuit Nederland account</a>.</p><p>Om in te loggen gebruikt u uw gebruikersnaam (%s) of uw e-mailadres (%s) en het door u gekozen wachtwoord.</p>",
			'confirmation.error'	=> "Er is iets misgegaan bij het activeren van uw account. Neemt u alstublieft even contact op met de administratie.",
			'payment.done'			=> "Bedankt voor uw aanmelding!",
			'payment.done.explain'	=> "Uw circulair geld account staat bijna voor u klaar. Zou u zo vriendelijk willen zijn uw e-mailadres te bevestigen? Gaat u daarvoor naar uw email (%s) en open de email die u heeft gekregen van Circuit Nederland. Daarin zit een link die u moet openen om de registratie te voltooien. <br><br>Mocht u de email niet kunnen vinden, kijk dan voor de zekerheid ook even in uw spam box. Wij verifi&euml;ren uw betaling nadat u uw email bevestigd heeft. Mocht onverhoopt uw betaling niet in orde zijn, maakt u zich geen zorgen. In dat geval krijgt u automatisch een nieuwe betaallink nadat u uw e-mailadres bevestigd heeft.",
