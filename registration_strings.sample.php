...
function lang($phrase){
	static $lang = array(
			...
			'confirmation.explain'	=> "<p>Gefeliciteerd, uw account is geactiveerd.</p><p>U kunt nu inloggen in uw <a href=\"%s\" target=\"_blank\">Circuit Nederland account</a>.</p><p>Om in te loggen gebruikt u uw gebruikersnaam (%s) of uw e-mailadres (%s) en het door u gekozen wachtwoord.</p>",
			...
			'payment.done.explain'	=> "Uw circulair geld account staat bijna voor u klaar. Zou u zo vriendelijk willen zijn uw e-mailadres te bevestigen en daarmee uw registratie te voltooien? Dit doet u door te klikken op de link in de mail die Circuit Nederland gestuurd heeft naar uw opgegeven emailadres (%s).<br><br>Mocht u de email niet kunnen vinden, kijk dan voor de zekerheid ook even in uw spam box. Wij verifi&euml;ren uw betaling nadat u uw email bevestigd heeft. Mocht onverhoopt uw betaling niet gelukt zijn, maakt u zich geen zorgen. In dat geval krijgt u automatisch een nieuwe betaallink nadat u uw e-mailadres bevestigd heeft.",
