...
function lang($phrase){
	static $lang = array(
			...
			'error.noServerContact' => "Kan geen verbinding maken met Circuit Nederland. Als dit probleem zich blijft voordoen neem dan alstublieft contact op met de administratie.", 
			...
			'field.validation'		=> "Om uw inschrijving af te ronden, vink alstublieft hieronder aan dat u geen robot bent en dat u akkoord gaat met de Algemene Voorwaarden en de automatische incasso.",
			...
			'field.zip'				=> "Postcode",
			'field.username.uitleg'	=> "Vul hieronder uw gebruikersnaam in, via deze gebruikersnaam kunt u betalingen ontvangen van andere leden. Kies een naam die bij u past en die u goed met anderen kunt delen. Deze naam moet uniek zijn.",			
			...
			'confirmation.explain'	=> "<p>Gefeliciteerd, uw account is geactiveerd.</p><p>U kunt nu inloggen in uw <a href=\"%s\" target=\"_blank\">Circuit Nederland account</a>.</p><p>Om in te loggen gebruikt u uw gebruikersnaam (%s) of e-mailadres (%s) en het door u gekozen wachtwoord.</p><p>Gebruik ook onze gemakkelijke Circuit Nederland app op uw smartphone! U kunt er mee betalen, betaalverzoeken sturen, en zien welke bedrijven er meedoen. Download de app uit de <a href=\"https://play.google.com/store/apps/details?id=nl.circuitnederland.mobile&hl=nl/\" target=\"_blank\">Google Play store</a> of <a href=\"https://itunes.apple.com/nl/app/circuit-nederland/id1071433138?mt=8\" target=\"_blank\">Apple App store</a>.</p>",
			...
			'title.section3.text'	=> "Nadat u uw gegevens hebt ingevuld, wordt u automatisch doorgezonden naar een iDEAL betaalpagina. Hier betaalt u de inschrijfkosten. ",
			'title.section4.title'	=> "Bevestig uw inschrijving",
			'title.section4.text'	=> "Nadat u betaald hebt, bevestigt u uw registratie door te klikken op de link in de activatie email. Geen email ontvangen? Kijk dan in uw spam folder.",
			...
			'community.section2.text'	=> "Nadat u uw gegevens hebt ingevuld, wordt u automatisch doorgezonden naar een iDEAL betaalpagina. Hier betaalt u de inschrijfkosten. ",
			'community.section3.title'	=> "Bevestig uw inschrijving",
			'community.section3.text'	=> "Nadat u betaald hebt, bevestigt u uw registratie door te klikken op de link in de activatie email. Geen email ontvangen? Kijk dan in uw spam folder.",
