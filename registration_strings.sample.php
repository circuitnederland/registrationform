...
function lang($phrase){
	static $lang = array(
			...
			'field.zip'				=> "Postcode",
			'field.username.uitleg'	=> "Vul hieronder uw gebruikersnaam in. Uw gebruikersnaam is zichtbaar voor andere leden. Kies daarom een naam die bij u past en die u met anderen kunt delen. De gebruikersnaam moet uniek zijn en tussen de 2 en 16 tekens lang zijn.",			
			...
			'title.section5.text'	=> "Nu kunt u zoeken naar deelnemende bedrijven en hun producten en diensten, online of via de app, beschikbaar voor <a href='https://play.google.com/store/apps/details?id=nl.circuitnederland.mobile' target='_blank'>Android</a> en <a href='https://apps.apple.com/nl/app/united-economy/id1071433138' target='blank'>Iphone</a>. En u kunt circulair geld besteden bij andere leden als u kiest voor een circulair geld betaalrekening.",
