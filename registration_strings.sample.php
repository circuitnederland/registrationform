...
function lang($phrase){
	static $lang = array(
			...
			'title.section3.text'	=> "Nadat je jouw gegevens hebt ingevuld, word je automatisch doorgezonden naar een iDEAL betaalpagina. Hier betaal je de inschrijfkosten. ",
			...
			'community.section2.text'	=> "Nadat je jouw gegevens hebt ingevuld, word je automatisch doorgezonden naar een iDEAL betaalpagina. Hier betaal je de inschrijfkosten. ",
